...
//comments daal dena yaad se(this is the main card which will be showw on the body) 
const htmlTaskContent = ({ id, title, description, type, url }) => `
   <div class='col-md-6 col-lg-4 mt-3' id = ${id} key = ${id} >
        ...
        `
            ...
            `
        : `
            <img width='100%' src=image/default.jpg alt='card image cap' class='card-image-top md-3 rounded-lg'/>
            `
    }  
...
`;
// open task par click krne k baad ka codde hai 
